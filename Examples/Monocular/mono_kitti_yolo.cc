...
// 	cout<< "width"<< w << endl<<endl;
	...
	//cv::Mat mask = cv::Mat::ones(480,640,CV_8U);
        ...
        SLAM.TrackMonocularyolo(im,mask,tframe,vector<ORB_SLAM3::IMU::Point>(), vstrImageFilenames[ni]);
    ...
    SLAM.SaveTrajectoryTUM("CameraTrajectory.txt");//add
