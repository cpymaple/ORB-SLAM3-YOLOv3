...
public:
    ...
    //cv::Mat TrackRGBDyolo(const cv::Mat &im, const cv::Mat &depthmap, cv::Mat &mask, const double &timestamp, cv::Mat &imRGBOut, cv::Mat &imDOut, cv::Mat &maskOut, string filename="");
    cv::Mat TrackRGBDyolo(const cv::Mat &im, const cv::Mat &depthmap, cv::Mat &mask, const double &timestamp, string filename="");
    ...
    cv::Mat TrackMonocularyolo(const cv::Mat &im, const cv::Mat &mask, const double &timestamp, const vector<IMU::Point>& vImuMeas = vector<IMU::Point>(), string filename="");
