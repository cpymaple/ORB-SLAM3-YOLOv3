...
public:
    ...
    //cv::Mat GrabImageRGBDyolo(const cv::Mat &imRGB, const cv::Mat &imD, cv::Mat &mask, const double &timestamp, cv::Mat &imRGBOut, cv::Mat &imDOut, cv::Mat &maskOut, string filename);
    cv::Mat GrabImageRGBDyolo(const cv::Mat &imRGB, const cv::Mat &imD, cv::Mat &mask, const double &timestamp, string filename);
    cv::Mat GrabImageMonocular(const cv::Mat &im, const double &timestamp, string filename);
    cv::Mat GrabImageMonocularyolo(const cv::Mat &im, const cv::Mat &mask, const double &timestamp, string filename);
